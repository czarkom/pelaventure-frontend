        ...
        <StyledToolbar variant="dense" disableGutters>
          <Box sx={{ flexGrow: 1, display: 'flex', alignItems: 'center', px: 0 }}>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              ...
              <Button variant="text" color="info" size="small">
                <a href="#testimonials" style={{ textDecoration: 'none' }}>Testimonials</a>
              </Button>
              <Button variant="text" color="info" size="small">
                <a href="#highlights" style={{ textDecoration: 'none' }}>Highlights</a>
              </Button>
              <Button variant="text" color="info" size="small">
          ...
          >
            <Button component={Link} to="/signin" color="primary" variant="outlined" size="small">
              Sign in
            </Button>
